                  ...
                  <div
                    ...
                    className={`group relative flex items-center gap-4 p-4 rounded-xl cursor-pointer transition-all duration-300 ${
                      selectedLanguage === "javascript"
                        ? "bg-gradient-to-r from-yellow-400/20 to-yellow-500/20 border-2 border-yellow-500 shadow-lg shadow-yellow-500/20"
                        : "bg-gray-700/30 border-2 border-gray-600 hover:border-yellow-400 hover:bg-gray-700/50"
                    }`}
                  >
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-yellow-400 to-yellow-500 flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                      <span className="text-3xl">🟨</span>
                    </div>
                    <div className="flex-1">
                      <h3 className="text-white font-semibold text-lg">
                      ...
                      <p className="text-gray-400 text-sm">
                        Programación web profesional con JavaScript moderno
                      </p>
                    </div>
                    {selectedLanguage === "javascript" && (
